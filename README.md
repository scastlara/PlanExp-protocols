...
The protocol for inferring gene co-expression relationships/gene regulatory interactions using GRNBoost can be found [here](markdowns/co-expression_network.md).
